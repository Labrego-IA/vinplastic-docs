    ...
    modulos: [
      {
        ...
        items: [
          ...
          'Prestador de serviço (transportadoras, financeiras) → e-mail comercial@vinplastic.com.br',
          'Saque/reclamação → e-mail sac@vinplastic.com.br',
        ...
        secoes: [
          {
            ...
            intro: [
              ...
              'A qualificação segue as regras de negócio da VinPlast. A Lumi identifica se o contato é consumidor final, revendedor, fornecedor, prestador de serviço ou saque/reclamação. Fornecedores tentando vender algo são descartados gentilmente. Prestadores de serviço (transportadoras, financeiras, empresas oferecendo serviços) são direcionados para comercial@vinplastic.com.br. Saques e reclamações vão para sac@vinplastic.com.br. Consumidores finais são classificados por subgrupo — indústria, indústria alimentícia, hospital, condomínio, hotéis — para posterior segmentação de marketing. Ticket abaixo de R$ 2.000 vai para o e-commerce. Revendedores não são descartados: sem tabela de revenda, a Lumi pede o produto desejado. Ticket acima de R$ 5.000 segue para o vendedor por e-mail (3 primeiros pedidos sempre à vista, fluxo não imediato); abaixo de R$ 5.000 é tratado como consumidor final.',
            ...
            blocos: [
              {
                ...
                cards: [
                  ...
                  { title: '3. Roteamento por tipo', desc: 'Fornecedor → descarte gentil. Prestador de serviço → comercial@vinplastic.com.br. Saque → sac@vinplastic.com.br. Revendedor > R$5k → vendedor (à vista). < R$2k → e-commerce', action: 'Regras automáticas' },
    ...
    telas: [
      ...
      },
      {
        ...
        campos: [
          ...
          { nome: 'Valor de corte revendedor (R$)', tipo: 'moeda', obrigatorio: true, validacao: 'Revendedor acima deste valor → vendedor por e-mail (3 primeiros pedidos à vista, não imediato); abaixo → tratado como consumidor final. Default: R$ 5.000. Sem tabela de revenda: a Lumi pede o produto desejado.' },
